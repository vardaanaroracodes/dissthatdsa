...
// Admin login page using NextAuth credentials + Google
// Modern light card centered on neutral background
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="space-y-1 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Access your classes, registrations and email campaigns.
          </p>
        </div>

        <Card className="border bg-background/80 backdrop-blur-sm p-6 shadow-sm">
...
function LoadingState() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted">
      <span className="text-sm text-muted-foreground">Loading admin sign in…</span>
    </div>
  );
}
